object OptDialog: TOptDialog
  ...
  object Misc: TPageControl
    ...
    object TabSheet6: TTabSheet
      ...
      object NlosOnnxEnable: TCheckBox
        Left = 38
        Top = 243
        Width = 121
        Height = 17
        Caption = 'Enable NLOS ML ONNX'
        TabOrder = 9
        OnClick = FreqChange
      end
      ...
      object LabelNlosDeweightGain: TLabel
        ...
        Width = 101
        Height = 13
        Caption = 'NLOS Deweight Gain'
      end
      object NlosDeweightGain: TEdit
        Left = 142
        Top = 288
        Width = 60
        Height = 21
      ...
      object LabelNlosArThreshold: TLabel
        ...
        Width = 101
        Height = 13
        Caption = 'NLOS AR Threshold'
      end
      object NlosArThreshold: TEdit
        Left = 142
        Top = 311
        Width = 60
        Height = 21
